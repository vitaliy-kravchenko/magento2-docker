...
build:
	...
	@echo "\n\033[1;92m--> Create magento project\033[0m\n"
	...
	@echo "\n\033[1;92m--> Install magento\033[0m\n"
...
sampledata:
	...
	docker-compose exec magento2-php bash -c 'bin/magento sampledata:deploy && bin/magento setup:upgrade'
